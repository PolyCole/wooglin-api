...
router.register(r'sober-bro-shifts', views.SoberBroShiftViewSet, basename='sober-bro-shifts')
router.register(r'sober-bro-shifts/assignments', views.SoberBroViewSet, basename='sober-bro-assignments')
